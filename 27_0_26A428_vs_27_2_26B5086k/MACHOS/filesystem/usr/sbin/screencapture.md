...
+  __TEXT.__const: 0x5aac
+  __TEXT.__swift5_typeref: 0x183e
...
+ _$s12CoreGraphics6RegionVSTAAMc
...
CStrings:
+ "/usr/local/bin/dumpwindowlayers"
+ "com.apple.screencapture.resume-vi-hotkey"
+ "could not run %{public}s: %@"
+ "fileHandleForReading"
+ "isExecutableFileAtPath:"
+ "isLayerCaptureActive"
