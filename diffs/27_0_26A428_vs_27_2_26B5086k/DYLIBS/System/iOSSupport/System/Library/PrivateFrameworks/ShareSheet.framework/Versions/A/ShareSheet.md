...
Functions:
~ -[SHSheetContentDataSource _createDiffableSnapshotFromCurrentState] : 2896 -> 2916
~ -[UIDocumentInteractionController _isFilenameValidForDecompressing:allowsPreviewingArchive:] : 252 -> 312
```
