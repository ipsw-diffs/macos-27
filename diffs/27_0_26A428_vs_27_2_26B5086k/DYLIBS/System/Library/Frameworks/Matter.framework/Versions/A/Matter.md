...
-324.0.0.0.0
-  __TEXT.__text: 0x901240
-  __TEXT.__objc_methlist: 0x5dbf4
-  __TEXT.__const: 0x64069
-  __TEXT.__gcc_except_tab: 0xc6780
-  __TEXT.__cstring: 0x30cda
-  __TEXT.__oslogstring: 0x1a8de
-  __TEXT.__unwind_info: 0x51450
+331.0.0.0.0
+  __TEXT.__text: 0x909f2c
+  __TEXT.__objc_methlist: 0x5ea7c
+  __TEXT.__const: 0x650d9
+  __TEXT.__gcc_except_tab: 0xc93e4
+  __TEXT.__cstring: 0x31744
+  __TEXT.__oslogstring: 0x1aa02
+  __TEXT.__unwind_info: 0x51f60
   __TEXT.__objc_stubs: 0x0
   __TEXT.__auth_stubs: 0x0
   __TEXT.__objc_classname: 0x0
   __TEXT.__objc_methname: 0x0
   __TEXT.__objc_methtype: 0x0
-  __DATA_CONST.__const: 0x10298
-  __DATA_CONST.__objc_classlist: 0x3080
+  __DATA_CONST.__const: 0x10360
+  __DATA_CONST.__objc_classlist: 0x30d8
   __DATA_CONST.__objc_protolist: 0xb8
   __DATA_CONST.__objc_imageinfo: 0x8
   __DATA_CONST.__weak_got: 0x8
-  __DATA_CONST.__objc_selrefs: 0x1c610
+  __DATA_CONST.__objc_selrefs: 0x1cb50
   __DATA_CONST.__objc_protorefs: 0x20
-  __DATA_CONST.__objc_superrefs: 0x2228
+  __DATA_CONST.__objc_superrefs: 0x2260
   __DATA_CONST.__objc_arraydata: 0x38
-  __DATA_CONST.__got: 0x23e8
-  __AUTH_CONST.__const: 0x1f538
-  __AUTH_CONST.__cfstring: 0x18420
-  __AUTH_CONST.__objc_const: 0x75308
+  __DATA_CONST.__got: 0x2428
+  __AUTH_CONST.__const: 0x1fb48
+  __AUTH_CONST.__cfstring: 0x18960
+  __AUTH_CONST.__objc_const: 0x760b0
...
-  __AUTH.__objc_data: 0x1e500
+  __AUTH_CONST.__auth_got: 0x9e0
+  __AUTH.__objc_data: 0x1e870
   __AUTH.__data: 0x1a0
...
CStrings:
+ "%s:%d false: %s"
+ "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/TemporaryDirectory.<TMP>/Sources/CHIPFramework/connectedhomeip/src/platform/Linux/NFCCommissioningManagerImpl.h"
+ "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/TemporaryDirectory.<TMP>/Sources/CHIPFramework/connectedhomeip/src/protocols/bdx/AsyncTransferFacilitator.h"
...
+ "CondPumpEnabled"
+ "CondRunCount"
+ "Couldn't schedule dispatch of NFC tag response"
...
+ "Failed to allocate TagDiscoveryContext"
...
+ "Failed to schedule tag discovery dispatch: %s"
+ "Failed to start NFC worker Thread: %s"
...
+ "Invalid TagInstance detected. Discarding message"
+ "Irrigation System"
+ "MessageNotPresented"
+ "New TagInstance with cardHandle 0x%08X%08X"
+ "No Wi-Fi credentials configured at commissioner!"
+ "No tagInstance found with discr %d!"
+ "Null NFCMessage detected. Skipping"
+ "OAuthLoggedIn"
+ "PROXY:%u"
...
+ "SCardEstablishContext failed: %s"
...
+ "src/platform/Linux/NFCCommissioningManagerImpl.h"
+ "src/protocols/bdx/StatusCode.cpp"
+ "src/transport/raw/ProxyTransport.cpp"
+ "tagInstance with discr %d found"
- "%@ Setting NFCCommissioningManager with NFC Reader transport: %@"
- "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/TemporaryDirectory.<TMP>/Sources/CHIPFramework/connectedhomeip/src/app/CommandHandler.h"
- "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/TemporaryDirectory.<TMP>/Sources/CHIPFramework/connectedhomeip/src/lib/support/Variant.h"
...
- "Failed to start NFCProcessing Thread: %s"
