...
-3240.0.1.2.0
-  __TEXT.__text: 0x1b38b8
-  __TEXT.__objc_methlist: 0xc038
+3245.7.0.0.0
+  __TEXT.__text: 0x1b5bd8
...
+ GCC_except_table98
+ GCC_except_table999
+ OBJC_IVAR_$_AXEventTapManager._carPlayServiceVerdictCache
+ OBJC_IVAR_$_AXEventTapManager._carPlayServiceVerdictCacheLock
+ OBJC_IVAR_$_AXInvertColorsSettingsEvent._feature
+ OBJC_IVAR_$_AXInvertColorsSettingsEvent._processName
+ OBJC_IVAR_$_AXInvertColorsSettingsEvent._source
+ OBJC_IVAR_$_AXInvertColorsSettingsEvent._state
+ OBJC_IVAR_$_AXInvertColorsSettingsEvent._timestamp
+ OBJC_IVAR_$_AXServer._serverIdentifierLock
...
+ ___block_descriptor_40_e8_32bs_e39_v32?0^v8^v16^{__IOHIDServiceClient=}24l
...
- GCC_except_table956
- GCC_except_table983
- ___block_descriptor_40_e8_32s_e39_v32?0^v8^v16^{__IOHIDServiceClient=}24l
