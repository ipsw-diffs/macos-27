...
+  __TEXT.__oslogstring: 0x5ef6
+  __TEXT.__cstring: 0x2978
...
+ "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/TemporaryDirectory.<TMP>/Sources/CameraCapture/CinematicFraming/Common/CinematicFramingShared.m %s: Calibration data for %@ holds %zu bytes, expected %zu bytes"
+ "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/TemporaryDirectory.<TMP>/Sources/CameraCapture/CinematicFraming/Common/CinematicFramingShared.m %s: Calibration data for %@ is missing"
+ "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/TemporaryDirectory.<TMP>/Sources/CameraCapture/CinematicFraming/Common/CinematicFramingShared.m %s: Calibration data for %@ is not an NSData"
