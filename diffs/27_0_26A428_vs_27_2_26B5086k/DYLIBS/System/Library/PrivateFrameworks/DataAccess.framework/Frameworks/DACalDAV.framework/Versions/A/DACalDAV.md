...
Functions:
+ -[MobileCalDAVAccount telemetryServerType]
~ ___86-[MobileCalDAVPrincipal completeWithError:httpMethod:latency:task:responseStatusCode:]_block_invoke : 416 -> 396
~ -[MobileCalDAVCalendar putAction:completedWithError:] : 1048 -> 1068
CStrings:
+ ".apple.com"
+ "AppleInternal"
```
