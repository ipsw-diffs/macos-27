...
-  __DATA_CONST.__objc_selrefs: 0x6d28
+  __DATA_CONST.__objc_selrefs: 0x6d20
...
+  __AUTH_CONST.__objc_const: 0x1dff0
...
+  __DATA.__bss: 0x5030
   ...
   __DATA_DIRTY.__objc_data: 0x1c50
...
Symbols:
+ +[NSImage(PhotosUIFoundation) px_checkmarkImageWithBackgroundColor:foregroundColor:checked:]
...
+ OBJC_IVAR_$_PXSyntheticUIMediaProvider._delaysImageRequests
+ _PXAssetActionTypeShowAdjustKeywords
+ ___92+[NSImage(PhotosUIFoundation) px_checkmarkImageWithBackgroundColor:foregroundColor:checked:]_block_invoke
+ _arc4random_uniform
...
- -[PXNSScrollViewController preferredPocketUserInterfaceStyleForAllEdges]
- -[PXNSScrollViewController setPreferredPocketUserInterfaceStyleForAllEdges:]
...
- ___76+[NSImage(PhotosUIFoundation) px_checkmarkImageWithBackgroundColor:checked:]_block_invoke
- _objc_msgSend$_preferredScrollPocketAppearanceForEdge:
- _objc_msgSend$_setPreferredScrollPocketAppearance:forEdge:
