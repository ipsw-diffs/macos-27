...
+  __TEXT.__swift5_typeref: 0x1307
...
+  __DATA_CONST.__got: 0xd18
   ...
   __AUTH_CONST.__objc_const: 0xa5b8
...
+ _objc_msgSend$hostControlURLScheme
...
CStrings:
+ "%s: Failed to route refresh URL to scheme %{public}@."
+ "%s: No call host for joined conversation %@, skipping refresh."
+ "%s: TUCall does not respond to -hostControlURLScheme, falling back to unrouted URL."
