...
+  __TEXT.__const: 0x2c56
+  __TEXT.__cstring: 0xfa4
+  __TEXT.__swift5_typeref: 0x123c
+  __TEXT.__constg_swiftt: 0xf7c
+  __TEXT.__swift5_reflstr: 0xdd5
...
+ _symbolic SSIego_
+ _symbolic _____ 10SwiftMedia0077__FileSpecificFigNoteConfiguration_defined_by_FigNoteConfiguration_niIIAaqFdFb33_11D8AD35E7790E916D6304B5F5FED7EELLV
...
+ "%{public}s %{public}s%{public}sSet AudioDeviceUID: %{private}s"
+ "%{public}s %{public}s%{public}sSet AudioSessionID: %u"
+ "%{public}s %{public}s%{public}sSet BufferedAirPlayLocalPlaybackVolume: %f"
+ "%{public}s %{public}s%{public}sSet EnableBufferedAirPlayLocalPlayback: %{bool}d"
...
+ "%{public}s %{public}s%{public}s[%s] Callback from FigAssetCreateWithURLAsync with figAsset = %s, error = %d"
+ "%{public}s %{public}s%{public}s[%s] Calling FigAssetCreateWithURLAsync with URL: %s, flags: %s, options: %@"
