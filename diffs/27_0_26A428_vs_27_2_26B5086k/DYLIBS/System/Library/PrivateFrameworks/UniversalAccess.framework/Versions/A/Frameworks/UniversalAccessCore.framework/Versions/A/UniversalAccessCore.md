...
+  __TEXT.__objc_methlist: 0x2280
   ...
   __TEXT.__cstring: 0x2e36
   __TEXT.__oslogstring: 0x12d7
...
Symbols:
+ +[UABaseSystem _isValidVoiceLanguageFolderName:]
...
+ GCC_except_table968
+ _UADomainSidecarSettingsDidChangeNotification
+ _UASystemTranscriptionTranscriptionViewFaceTimeFontSize
+ _UASystemTranscriptionTranscriptionViewFaceTimeFontSizeKey
+ _UASystemTranscriptionTranscriptionViewFaceTimeSetFontSize
+ _objc_msgSend$_isValidVoiceLanguageFolderName:
