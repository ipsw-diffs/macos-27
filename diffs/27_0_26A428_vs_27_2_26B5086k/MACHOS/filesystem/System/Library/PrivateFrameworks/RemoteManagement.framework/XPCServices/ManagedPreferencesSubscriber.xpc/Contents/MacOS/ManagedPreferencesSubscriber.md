...
CStrings:
+ "AllowAutomaticNotes"
+ "T@\"NSNumber\",N,&,VpayloadAllowAutomaticNotes"
+ "T@\"NSNumber\",N,&,VpayloadAllowLiveRewind"
+ "payloadAllowAutomaticNotes"
+ "payloadAllowLiveRewind"
+ "setPayloadAllowAutomaticNotes:"
+ "setPayloadAllowLiveRewind:"
- "Label for an app identifier binary, including the list index number"
```
