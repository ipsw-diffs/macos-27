...
+  __TEXT.__auth_stubs: 0x9c0
   ...
   __TEXT.__cstring: 0x51b
-  __TEXT.__const: 0x12d0
-  __TEXT.__swift5_typeref: 0x76a
...
CStrings:
+ "PasskeyRegister failed due to missing presentation window"
```
